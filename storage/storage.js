...
var Dom = require('xmldom').DOMParser;
var XMLSerializer = require('xmldom').XMLSerializer;
var collections_xml = '/home/ned/test2.xml';
var images_folder = '/home/ned/images/'

exports.user_entry = function(req, res){
    //getAllCollectionsUpdated();
    //stringToTitle(strTitle)
    //getAllCollections();
    //saveCollection('collection2');    //parameter is the summary or title of collection     
    //getCollection(1);       //parameter is collection id
    //deleteCollection(2);         //parameter is the collection id
    //getCollectionImagesDescription(1);     //param is for collection id
    //getCollectionImageDescription(1,1);    //first parameter is collection id, the second image id
    //saveImage(1, "Suberb cat2", "image/jpeg");  //first param is collectionID, second param is summary or title, third is mimeType
    //getImage(1, 1); // first parameter is collection id, second is image id
    //deleteImage(1,2);   //first id is for collection, second is for image to be deleted
    //getAllCollectionCommentsUpdated(1);  //returns the "updated" element (the last modified time of all comments associated with a collection)
    //getAllCollectionComments(1); //parameter is collection id
    //saveCollectionComment(1, 'oh lovely collection2');  //first id is for collection, second parameter is for comment to be saved
    //getCollectionComment(1,1);  //first parameter is collection id, the second comment id
    //deleteCollectionComment(1, 2);  //first id is for collection, second is for comment to be deleted
    //getAllCollectionTagsUpdated(1);  // the param is for collection id
    //getAllCollectionTags(1);    //param is collection id
    //saveCollectionTag('collection 1 data again!', 1);  //first param is metadata to be added, second is collection id
    //getCollectionTag(1, 1);     //param 1 is collection id, param 2 is metadata id
    //deleteCollectionTag(1, 2);      //param is collection id, param 2 is metadata id
    //getAllImageTagsUpdated(1, 1);  ////returns the "updated" element (the last modified time of all tags associated with a collection)
    //getAllImageTags(1, 1);      //param 1 is collection id, param2 is image id
    //saveImageTag('nice image', 1, 1) //param 1 is metaData, param2 is collection id, param 3 is imageid
    //getImageTag(1, 1, 2);     //param 1 is collection id, param2 is imageid, param3 is metadata id
    //deleteImageTag(1,1,2)  //param 1 is collection id, param2 is imageid, param3 is metadata id
...
function saveCollection(summary) {   //parameter is summary or title of collection
...
function getCollectionImagesDescription(colID) {
...
function getCollectionImageDescription(colID,imageID) {
    var imageDesc = new Object();
...
function saveImage(colID, summary, mimeType) {   //"/public/images/"
    var resultImage = new Object();
    //var http = require('http');
    var imageCount;
    var newImageId;
...
function getImage(colID, imageID) {
...
function deleteImage(colID, imageID) {
...
function getAllCollectionComments(id) {
    var collectionCommentList = new Array();
    var comments = [];
...
function saveCollectionComment(colID, comment_) {
    var comment = new Object();
    var resultComment = new Object();
...
function getCollectionComment(id, id2) {    //id is for collection, id2 is for comment
    var comment = new Object();
...
function deleteCollectionComment(id, id2) {    //id is for collection, id2 is for comment to be deleted
...
function getAllCollectionTags(id) {
...
function saveCollectionTag(metaData_, colID) {  //adds metadata to collection
...
function getCollectionTag(id, id2) {    //id is for collection, id2 is for metadata
...
function deleteCollectionTag(id, id2) {     //id is for collection, id2 is for metadata to be deleted
...
function getAllImageTags(colID, imageID) {
...
function saveImageTag(_metaData, colID, imageID) {
...
function getImageTag(colID, imageID, tagID) {
...
function deleteImageTag(colID, imageID, tagID)  {
